...
export function HomePage() {
  ...
  const activeSlideId =
    hoveredSlideId ?? currentSlideId ?? showcaseSlides[0]?.id ?? null
          ...
          <div className="hero-slider__track">
            {showcaseSlides.map((slide, index) => {
              ...
              const secondaryTitle =
                language === "ar" ? slide.title_en : slide.title_ar
                ...
                >
                  ...
                  <span className="hero-slide__label">
                    ...
                    <strong
                      ...
                      dir={primaryLanguage === "ar" ? "rtl" : "ltr"}
                    >
                      {primaryTitle}
                    </strong>
...
function CarFilters({
  ...
  const field = <K extends keyof Filters>(
    key: K,
    value: Filters[K],
      ...
      <Filter label={t("public.cars.transmission")}>
        <select
          ...
          onChange={(event) =>
            field(
              "transmission",
              event.target.value as Filters["transmission"],
            )
          }
        >
