...
const THEMES = [
  {
    nameKey: "admin.pages.light",
    icon: "sun" as const,
    descriptionKey: "admin.pages.lightDescription",
    value: "light" as const,
  },
  {
    nameKey: "admin.pages.dark",
    icon: "moon" as const,
    descriptionKey: "admin.pages.darkDescription",
    value: "dark" as const,
  },
]
      ...
      <div className="settings-grid">
        <article className="settings-card appearance-card">
          <div className="settings-card__title">
            ...
            <div>
              <h2>{t("admin.pages.appearance")}</h2>
              <p>{t("admin.pages.appearanceDescription")}</p>
            </div>
          </div>
          ...
          <div
            ...
            role="radiogroup"
            aria-label={t("admin.pages.appearanceThemes")}
          >
            {THEMES.map((theme) => {
              ...
              return (
                <label
                  className={`appearance-option appearance-option--${theme.value}${
                    selected ? " selected" : ""
                  }`}
                  key={theme.nameKey}
                >
